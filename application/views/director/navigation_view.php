            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('director/student/index');?>"><i class="fa fa-dashboard fa-fw"></i> Alumnos</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('director/teacher/index');?>"><i class="fa fa-bar-chart-o fa-fw"></i> Profesores</a>
